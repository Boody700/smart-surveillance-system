...
while True:
    ...
    results = model.track(
        ...
        conf=0.20,      # Lower confidence threshold to catch more distant people (Agent 2 will filter out the noise)
    ...
    if frame_results.boxes.id is not None:
        ...
        # Only count consecutive frames so ghost IDs can never accumulate
        # enough frames by appearing and disappearing repeatedly.
