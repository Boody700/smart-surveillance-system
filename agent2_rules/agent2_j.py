...
def main():
    ...
    # 2. Load Events (Added timeout to prevent locking errors)
    ...
    for pid, detections in people.items():
        for det in detections:
            ...
            # 🛑 FIX: Skip this entry if tracking data/coordinates are missing
            ...
            if ts <= WARMUP_SECONDS:
                ...
                if curr_zone is not None: 
                    zone_votes[pid][curr_zone] = zone_votes[pid].get(curr_zone, 0) + 1
                continue
